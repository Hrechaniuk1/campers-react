...
export default function Loader() {
    return (
        <div className={css.container}>
            <p className={css.title}>Завантаження...</p>
    ...
    <div className={css.circle12}></div>
    <div className={css.circle13}></div>
    <div className={css.circle14}></div>
    <div className={css.circle15}></div>
</div>
</div>
    )
}